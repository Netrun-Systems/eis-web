    ...
    <div className="max-w-6xl space-y-4">
      <div className="text-xs">
        <Link
          ...
          className="text-petrol-ink dark:text-petrol-light hover:text-petrol-dark dark:hover:text-petrol hover:underline"
        >
          &larr; All tables
        </Link>
      </div>
          ...
          {saveSuccess !== null && (
            <div className="rounded border border-petrol/40 bg-petrol-wash px-3 py-2 text-sm text-petrol-ink dark:border-petrol-dark dark:bg-petrol-tint dark:text-petrol-light">
              ...
              <span className="text-dust-600 dark:text-dust-300">
                {' '}
                · {summarizeValidationReport(saveSuccess.validationReport)}
              </span>
            </div>
          )}
                            ...
                            <td
                              ...
                              className={`max-w-md truncate px-2 py-1 font-mono ${
                                flagged
                                  ...
                                  : 'text-dust-600 dark:text-dust-300'
                              }`}
                              title={cell}
                            >
                              {cell}
